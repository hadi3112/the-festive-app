...
class SpinnerCurrentlocatioAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerCurrentlocatioModel>
) : ArrayAdapter<SpinnerCurrentlocatioModel>(mContext, layoutResource, allItems) {
